# Security Overview
> **Note** When it comes to testing, I primarily tested my API using an .http file to make HTTP requests. I did not implement integration testing, as it was too time-consuming and honestly overkill for this type of simple API
---
